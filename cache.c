...
static int read_in_clean_lines = 0;
static int read_in_dirty_lines = 0;
	     ...
	     md_addr_t *repl_addr)	/* for address of replaced block */
{
 ...
 cache_hit: /* slow hit handler */
  ...
  {
    if(!strcmp(cp->name, "dl3") || !strcmp(cp->name, "il3") || !strcmp(cp->name, "ul3"))
    {
...
int get_read_in_clean_lines()
{
  return read_in_clean_lines;
}

int get_read_in_dirty_lines()
{
  return read_in_dirty_lines;
}
